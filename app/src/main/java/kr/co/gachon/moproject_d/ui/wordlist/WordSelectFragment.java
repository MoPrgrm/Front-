...
public class WordSelectFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView tvTitleWord = view.findViewById(R.id.tvTitleWord);
        tvTitleWord.setOnClickListener(v -> {
        ...
        btnEnglish.setOnClickListener(v -> {
            ...
            Navigation.findNavController(v).navigate(R.id.wordlistLanguageFragment, args);
        });
